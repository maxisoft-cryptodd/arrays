...
public:
     ...
     */
    virtual std::expected<memory::vector<std::byte>, std::string> compress(std::span<const std::byte> uncompressed_data) = 0;
     ...
     */
    virtual std::expected<memory::vector<std::byte>, std::string> decompress(std::span<const std::byte> compressed_data) = 0;
};
